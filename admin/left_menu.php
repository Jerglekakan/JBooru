...
<head>
<?php
echo '<link rel="stylesheet" type="text/css" media="screen" href="'.$site_url.'default.css" title="default" />
...
<body>
	<div id="header">
		<h2 id="site-title"><?php echo '<a href="'.$site_url.'admin/">Moderation Tasks</a>' ?> / <?php echo '<a href="'.$site_url.'index.php?page=post&s=list"><i>View Board</i></a>' ?></h2><span style="color: #999999; padding-left: 20px;">Hover over links for more info.</span><br><br><br>
	</div>
	<div id="content">
	<div id="post-list">
	<div class="sidebar">
...
?>
	...
	<a href="?page=batch_add" title="Import images on server">Batch Add</a><br/><br/>
