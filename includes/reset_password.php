<?php
	...
	if(isset($_POST['username']) && $_POST['username'] != "")
	{
		...
		{	
			...
			{		
				$misc = new misc();
				$code = hash('sha256',bin2hex(random_bytes(128)).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()).mt_rand(0,getrandmax()));
